...
import 'package:mulite/screens/main_screen.dart';
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('Запам\'ятати мене', style: GoogleFonts.montserrat(fontSize: 14, color: Colors.white70)),
                      ],
                    ),
                  ),
                ],
              ...
              children: [
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () => Navigator.push(context, CustomPageRoute(page: const MainScreen())),
                ...
                SizedBox(
                  ...
                  height: 50,
                  child: ElevatedButton(
                    onPressed: () => Navigator.push(context, CustomPageRoute(page: RegisterScreen())),
